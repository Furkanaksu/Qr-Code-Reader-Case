...
class CashierActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var currencyUnit = arrayListOf(
            "Lütfen Ödeme Türünü Seçiniz",
            "Tamamlandı",
            "Beklemede",
            "Reddedildi"
        )
        var currencyUnitAdapter = ArrayAdapter(
            this,
            R.layout.spinner_item,
            currencyUnit
        )

        spinner?.adapter = currencyUnitAdapter
        ...
        barcodeScanner.process(inputImage)
            .addOnSuccessListener { barcodes ->
                barcodes.forEach {
                    ...
                    val bundle1 = Bundle()
                    bundle1.putString("qrcode_readed","true")

                    mFirebaseAnalytics?.logEvent("qrcode_readed", bundle1)
                    imageProxy.close()
